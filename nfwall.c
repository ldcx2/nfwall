...
#define MAX_BLOCKED_IPS 2
char* blocked_ips[MAX_BLOCKED_IPS];
...
void Ban(char* host, u_short port, u_short dst_port, int type)
{
    // Check if the IP address is already in the list of blocked IPs
    ...
    // Add the IP address to the list of blocked IPs
